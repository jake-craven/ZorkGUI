...
string Space::shortDescription() { return description; }
...
vector<Item> Space::displayItem() { return itemsInRoom; }

int Space::numberOfItems() { return itemsInRoom.size(); }
...
void Space::setX(int x1) { x = x1; }
void Space::setY(int y1) { y = y1; }
int Space::getType() { return type; }
void Space::setFire() { fire = true; }

void Space::setNextFire() { nextFire = true; }
bool Space::getNextFire() { return nextFire; }
bool Space::getFire() { return fire; }
